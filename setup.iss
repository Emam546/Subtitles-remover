...
#define MyAppName "Subtitles Remover"
#define MyAppVersion "0.0.5-beta"
#define MyAppPublisher "Imam Ashour"
#define MyAppURL "https://github.com/Emam546/subtitles-remover"
#define MyAppExeName "subtitles-remover.exe"
#define MyAppAssocName MyAppName + " setup"
#define MyAppAssocExt ".myp"
#define MyAppAssocKey StringChange(MyAppAssocName, " ", "") + MyAppAssocExt
#define SourcePath "dist\win-unpacked"
#define OutputPath "dist"
#define OutputName "subtitles-remover-setup-v" + MyAppVersion + "-win"
[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{bf7b99b2-2125-4431-bf9c-3745e2252183}
AppName={#MyAppName}
